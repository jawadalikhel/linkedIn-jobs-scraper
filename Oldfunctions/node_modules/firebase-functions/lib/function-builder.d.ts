import * as express from './node_modules/firebase-functions/lib/node_modules/express';
import { CloudFunction, EventContext } from './providers/node_modules/firebase-functions/lib/cloud-functions';
import { DeploymentOptions, RuntimeOptions, SUPPORTED_REGIONS } from './node_modules/firebase-functions/lib/function-configuration';
import * as analytics from './node_modules/firebase-functions/lib/providers/analytics';
import * as auth from './node_modules/firebase-functions/lib/providers/auth';
import * as crashlytics from './node_modules/firebase-functions/lib/providers/crashlytics';
import * as database from './node_modules/firebase-functions/lib/providers/database';
import * as firestore from './node_modules/firebase-functions/lib/providers/firestore';
import * as https from './node_modules/firebase-functions/lib/providers/https';
import * as pubsub from './node_modules/firebase-functions/lib/providers/pubsub';
import * as remoteConfig from './node_modules/firebase-functions/lib/providers/remoteConfig';
import * as storage from './node_modules/firebase-functions/lib/providers/storage';
import * as testLab from './node_modules/firebase-functions/lib/providers/testLab';
/**
...
export declare class FunctionBuilder {
    ...
    get https(): {
         ...
         */
        onRequest: (handler: (req: https.Request, resp: express.Response) => void) => import("./providers/node_modules/firebase-functions/lib/cloud-functions").HttpsFunction;
        /**
         * Declares a callable method for clients to call using a Firebase SDK.
         * @param handler A method that takes a data and context and returns a value.
         */
        onCall: (handler: (data: any, context: https.CallableContext) => any | Promise<any>) => import("./providers/node_modules/firebase-functions/lib/cloud-functions").TriggerAnnotated & ((req: express.Request<import("./node_modules/firebase-functions/lib/node_modules/express-serve-static-core").ParamsDictionary>, resp: express.Response<any>) => void | Promise<void>) & import("./providers/node_modules/firebase-functions/lib/cloud-functions").Runnable<any>;
    };
    get database(): {
        /**
